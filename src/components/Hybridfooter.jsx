// FILE: src/components/Hybridfooter.jsx
  ...
  return (
    <footer className="relative text-white overflow-hidden" role="contentinfo">
      ...
      <svg className="absolute -top-[1px] left-0 right-0 w-full" viewBox="0 0 1440 80" preserveAspectRatio="none" aria-hidden>
        <path
          d="M0,64 L48,58.7 C96,53,192,43,288,42.7 C384,43,480,53,576,58.7 C672,64,768,64,864,53.3 C960,43,1056,21,1152,21.3 C1248,21,1344,43,1392,53.3 L1440,64 L1440,0 L0,0 Z"
          fill="#000"
          opacity="0.9"
        />
      </svg>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-8 gap-8 md:gap-12">
          ...
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} className="col-span-2">
            <motion.div variants={fadeUp} className="flex items-center gap-3 mb-6">
              <a className="flex items-center gap-2" aria-label={BRAND.id} href="/">
                <BrandLogo size={40} />
              </a>
            </motion.div>
          ...
          {/* Six link groups */}
          {cols.map((col) => (
            <motion.div key={col.title} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} className="col-span-1">
        ...
        <div className="mt-12 flex flex-col md:flex-row items-center justify-between gap-6 border-t border-white/10 pt-8">
          ...
          <div className="grid grid-cols-4 gap-3">
            {[{ I: Facebook, n: "Facebook" }, { I: Instagram, n: "Instagram" }, { I: Youtube, n: "YouTube" }, { I: Linkedin, n: "LinkedIn" }].map(
              ({ I, n }, i) => (
                <a
                  key={i}
                  href="#"
        ...
        <div className="mt-8 mb-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-white/60">
          ...
          <button
            type="button"
            onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
            className="inline-flex items-center gap-2 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-400/30 rounded"
          >
